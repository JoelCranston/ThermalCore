...
public class PressRecipe extends ThermalRecipe {
    ...
    public PressRecipe(int energy, float experience, List<Ingredient> inputItems, List<FluidIngredient> inputFluids, List<ItemStackTemplate> outputItems, List<Float> outputItemChances, List<FluidStackTemplate> outputFluids) {
        ...
        if (this.energy <= 0) {
            ...
            ThermalCore.LOG.warn("Energy value for a Multiservo Press recipe was out of allowable range and has been set to a default value of " + defaultEnergy + ".");
