...
public class PyrolyzerRecipe extends ThermalRecipe {
    ...
    public PyrolyzerRecipe(int energy, float experience, List<Ingredient> inputItems, List<FluidIngredient> inputFluids, List<ItemStack> outputItems, List<Float> outputItemChances, List<FluidStack> outputFluids) {
