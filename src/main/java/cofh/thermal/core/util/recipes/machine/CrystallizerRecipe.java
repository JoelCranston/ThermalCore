...
import static cofh.thermal.core.init.registries.TCoreRecipeSerializers.CRYSTALLIZER_RECIPE_SERIALIZER;
...
public class CrystallizerRecipe extends ThermalRecipe {
    ...
    public CrystallizerRecipe(int energy, float experience, List<Ingredient> inputItems, List<FluidIngredient> inputFluids, List<ItemStackTemplate> outputItems, List<Float> outputItemChances, List<FluidStackTemplate> outputFluids) {
        ...
        if (this.energy <= 0) {
            ...
            ThermalCore.LOG.warn("Energy value for a Crystallizer recipe was out of allowable range and has been set to a default value of " + defaultEnergy + ".");
