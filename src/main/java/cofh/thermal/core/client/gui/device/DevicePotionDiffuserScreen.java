...
public class DevicePotionDiffuserScreen extends AugmentableTileScreen<DevicePotionDiffuserMenu> {
    ...
    public DevicePotionDiffuserScreen(DevicePotionDiffuserMenu container, Inventory inv, Component titleIn) {
