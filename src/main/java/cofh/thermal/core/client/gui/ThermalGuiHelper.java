...
public class ThermalGuiHelper {
    ...
    public static ElementConditionalLayered createDefaultMachineConfigTop(IGuiAccess gui, String machine, Reconfigurable4WayBlockEntity tile) {
    ...
    public static ElementConditionalLayered createDefaultMachineConfigBottom(IGuiAccess gui, String machine, Reconfigurable4WayBlockEntity tile) {
    ...
    public static ElementConditionalLayered createDefaultMachineConfigLeft(IGuiAccess gui, String machine, Reconfigurable4WayBlockEntity tile) {
    ...
    public static ElementConditionalLayered createDefaultMachineConfigRight(IGuiAccess gui, String machine, Reconfigurable4WayBlockEntity tile) {
    ...
    public static ElementConditionalLayered createDefaultMachineConfigFace(IGuiAccess gui, String machine, Reconfigurable4WayBlockEntity tile) {
    ...
    public static ElementConditionalLayered createDefaultMachineConfigBack(IGuiAccess gui, String machine, Reconfigurable4WayBlockEntity tile) {
    ...
    public static ElementConditionalLayered[] createDefaultMachineConfigs(IGuiAccess gui, String machine, Reconfigurable4WayBlockEntity tile) {
