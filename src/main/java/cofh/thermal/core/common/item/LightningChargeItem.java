...
import static cofh.thermal.core.init.registries.TCoreSounds.SOUND_BLITZ_SHOOT;
...
public class LightningChargeItem extends ItemCoFH {
    ...
    private void playUseSound(Level worldIn, BlockPos pos) {
        ...
        worldIn.playSound(null, pos, SOUND_BLITZ_SHOOT.get(), SoundSource.BLOCKS, 1.0F, (worldIn.getRandom().nextFloat() - worldIn.getRandom().nextFloat()) * 0.2F + 1.0F);
    }
