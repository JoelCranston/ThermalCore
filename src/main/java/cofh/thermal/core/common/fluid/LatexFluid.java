...
public class LatexFluid extends FluidCoFH {
    ...
    protected LatexFluid() {
        ...
        bucket = toolsTab(1000, ITEMS.register(bucket(ID_FLUID_LATEX), () -> new BucketItem(stillFluid.get(), itemProperties().craftRemainder(Items.BUCKET).stacksTo(1))));
    }
    ...
    public static final Supplier<FluidType> TYPE = FLUID_TYPES.register(ID_FLUID_LATEX, () -> new FluidType(FluidType.Properties.create()
            .density(950)
            .viscosity(2500)
        ...
        public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
            ...
            consumer.accept(new IClientFluidTypeExtensions() {
                ...
                private static final Identifier
                        STILL = Identifier.parse("thermal:block/fluids/latex_still"),
                        FLOW = Identifier.parse("thermal:block/fluids/latex_flow");
