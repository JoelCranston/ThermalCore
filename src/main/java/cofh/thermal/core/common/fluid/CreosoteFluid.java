...
public class CreosoteFluid extends FluidCoFH {
    ...
    protected CreosoteFluid() {
        ...
        bucket = toolsTab(1000, ITEMS.register(bucket(ID_FLUID_CREOSOTE), id -> new BucketItem(stillFluid.get(), itemProperties(id).craftRemainder(Items.BUCKET).stacksTo(1))));
    }
