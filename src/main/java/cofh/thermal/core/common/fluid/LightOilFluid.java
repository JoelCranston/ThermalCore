...
public class LightOilFluid extends FluidCoFH {
    ...
    protected LightOilFluid() {
        ...
        bucket = toolsTab(1000, ITEMS.register(bucket(ID_FLUID_LIGHT_OIL), () -> new BucketItem(stillFluid.get(), itemProperties().craftRemainder(Items.BUCKET).stacksTo(1))));
    }
        ...
        public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
            ...
            consumer.accept(new IClientFluidTypeExtensions() {
                ...
                private static final Identifier
                        STILL = Identifier.parse("thermal:block/fluids/light_oil_still"),
                        FLOW = Identifier.parse("thermal:block/fluids/light_oil_flow");
