...
public class LightOilFluid extends FluidCoFH {
    ...
    protected LightOilFluid() {
        ...
        bucket = toolsTab(1000, ITEMS.register(bucket(ID_FLUID_LIGHT_OIL), id -> new BucketItem(stillFluid.get(), itemProperties(id).craftRemainder(Items.BUCKET).stacksTo(1))));
    }
