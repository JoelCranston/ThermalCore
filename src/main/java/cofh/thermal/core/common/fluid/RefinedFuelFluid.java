...
public class RefinedFuelFluid extends FluidCoFH {
    ...
    protected RefinedFuelFluid() {
        ...
        bucket = toolsTab(1000, ITEMS.register(bucket(ID_FLUID_REFINED_FUEL), id -> new BucketItem(stillFluid.get(), itemProperties(id).craftRemainder(Items.BUCKET).stacksTo(1))));
    }
    ...
    public static final Supplier<FluidType> TYPE = FLUID_TYPES.register(ID_FLUID_REFINED_FUEL, () -> new FluidType(FluidType.Properties.create()
            .density(750)
            .viscosity(800)
