...
public class ResinFluid extends FluidCoFH {
    ...
    protected ResinFluid() {
        ...
        bucket = toolsTab(1000, ITEMS.register(bucket(ID_FLUID_RESIN), id -> new BucketItem(stillFluid.get(), itemProperties(id).craftRemainder(Items.BUCKET).stacksTo(1))));
    }
    ...
    public static final Supplier<FluidType> TYPE = FLUID_TYPES.register(ID_FLUID_RESIN, () -> new FluidType(FluidType.Properties.create()
            .density(900)
            .viscosity(3000)
