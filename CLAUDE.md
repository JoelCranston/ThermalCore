...
| `../ThermalCoreForNeoForge/` | Porting this repo to 1.21.1. SPLIGAN's minimal-diff 1.21.1 port of this exact codebase — `diff -ru src ../ThermalCoreForNeoForge/src` is the Phase A worklist (review each hunk, apply the API changes, skip their build/IDE noise). |
